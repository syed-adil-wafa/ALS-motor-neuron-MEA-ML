...
mea_config.wells_RB9d_corrected = ...
    [mea_config.plate.A(5:8), mea_config.plate.B(5:8), mea_config.plate.C(5:8)]; % RB9d-corrected
mea_config.wells_RB9d = ...
    [mea_config.plate.D(5:8), mea_config.plate.E(5:8), mea_config.plate.F(5:8), mea_config.plate.G(5:8), mea_config.plate.H(5:8)]; % RB9d
...
%% Plot early-stage development predictors
figure; hold on
suptitle('Predictive features in early-stage development');

% Plot # of spikes
feature = 1;
subplot(2, 2, 1);
timeplot(processing.df_39b_corrected, processing.df_39b, 1,...
    feature, '# of spikes (z-score)',...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'),...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'));

subplot(2, 2, 2);
timeplot(processing.df_RB9d_corrected, processing.df_RB9d, 2,...
    feature, '# of spikes (z-score)',...
...
subplot(2, 2, 3);
timeplot(processing.df_39b_corrected, processing.df_39b, 1,...
    feature, 'weighted mean firing rate (z-score)',...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'),...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'));
...
%% Plot mid-stage development predictors
figure; hold on
suptitle('Predictive features in mid-stage development');

% Plot # of electrodes participating in burst (average)
feature = 24;
subplot(3, 2, 1);
timeplot(processing.df_39b_corrected, processing.df_39b, 1,...
    feature, '# of electrodes in burst (z-score)',...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'),...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'));
...
subplot(3, 2, 3);
timeplot(processing.df_39b_corrected, processing.df_39b, 1,...
    feature, 'burst duration (std) (z-score)',...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'),...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'));
...
% Plot IBI coefficient of variation
feature = 15;
subplot(3, 2, 5);
timeplot(processing.df_39b_corrected, processing.df_39b, 1,...
    feature, 'IBI coefficient of variation (z-score)',...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'),...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'));
...
%% Plot late-stage development predictors
figure; hold on
suptitle('Predictive features in late-stage development');

% Plot area under normalized cross-correlation
feature = 30;
subplot(1, 2, 1);
timeplot(processing.df_39b_corrected, processing.df_39b, 1,...
    feature, 'area under normalized cross-correlation (z-score)',...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'),...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'));
