...
xlim([2 size(machine_learning.normalized_data, 3)]);
set(gca, 'XTick', 2:3:size(machine_learning.feature_importance, 2));
...
figure; hold on
suptitle('Electrophysiological features of patient and control neurons');

% Plot # of spikes
subplot(2, 6, 1);
title('Early-stage predictors');
...
% Plot ISI coefficient of variation
subplot(2, 6, 2);
title('Early-stage predictors');
timeplot(processing.df_39b, processing.df_39b_corrected, 1,...
    1, 'ISI coefficient of variation (z-score)',...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'),...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'));
...
% Plot # of network bursts
subplot(2, 6, 6);
title('Late-stage predictors');
timeplot(processing.df_39b, processing.df_39b_corrected, 1,...
    17, '# of network bursts (z-score)',...
    append('39b (n=', num2str(size(processing.df_39b, 1)), ')'),...
    append('39b-corrected (n=', num2str(size(processing.df_39b_corrected, 1)), ')'));
